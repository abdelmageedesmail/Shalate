...
public class ShopAdapter extends RecyclerView.Adapter<ShopAdapter.ViewHolder> {
    ...
    String flage;
    public ShopAdapter(Context context, ArrayList<CommentModel> commentModels) {
    ...
    public ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        return new ViewHolder(LayoutInflater.from(context).inflate(R.layout.shop_item_vav, parent, false));
    }
    @Override
